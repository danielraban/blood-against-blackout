...
const buttonVariants = cva(
  "inline-flex min-h-12 items-center justify-center gap-2 border-2 border-black px-4 text-base font-semibold lowercase tracking-wide transition-colors disabled:opacity-50",
  {
    variants: {
      variant: {
